...
/// Instruction variant used to analyze sharing across ISA bases
#[derive(Debug, Clone)]
...
/// RISC-V instruction code generator
...
impl CodeGenerator {
    ...
    /// Generate merged instruction enums
    ...
    /// Generate fully separated instruction enums (no merging; split by extension and ISA base)
